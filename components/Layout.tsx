...
export const Layout: VFC<Props> = ({
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen text-gray-600 text-sm font-mono">
      ...
      <main className="flex flex-1 flex-col justify-center items-center w-scren">
        {children}
      </main>
      <footer className="w-full h-12 flex justify-center items-center border-t">
        <a
          href="https://vercel.com?utm_source=create-next-app&utm_media=default-template&utm_campaign=create-next-app"
          target="_blank"
